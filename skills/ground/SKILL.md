...
3. Run `git status` in each repo in the current workspace — summarize what's in progress
4. Check for uncommitted changes, stale branches, or in-flight work
5. Summarize the current state concisely
6. Do NOT start any work until the user confirms
